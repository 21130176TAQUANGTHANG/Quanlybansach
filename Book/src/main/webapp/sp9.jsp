...
<section class="single_product_details_area d-flex align-items-center">
    ...
    <div class="single_product_desc clearfix">
        <span>mango</span>
        <a href="cart.html">
            <h2>Combo Manga - Asari - Cô Bé Tinh Nghịch: Tập 1 - 10 (Bộ 10 Cuốn)</h2>
        </a>
        <p class="product-price"><span class="old-price">250.000đ</span> 225.625đ</p>
        <!-- Form -->
