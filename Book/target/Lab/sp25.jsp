...
<section class="single_product_details_area d-flex align-items-center">
    ...
    <div class="single_product_desc clearfix">
        <span>mango</span>
        <a href="cart.html">
            <h2>Muôn Kiếp Nhân Sinh - Many Times, Many Lives - Tập 2 (Khổ Nhỏ)</h2>
        </a>
        <p class="product-price"><span class="old-price">148.000đ</span>96.200đ</p>
        <!-- Form -->
