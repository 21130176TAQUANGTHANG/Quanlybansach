...
<section class="single_product_details_area d-flex align-items-center">
    ...
    <div class="single_product_desc clearfix">
        <span>mango</span>
        <a href="cart.html">
            <h2>7 Thói Quen Hiệu Quả - The 7 Habits Of Highly Effective People - Bìa Cứng (Tái Bản 2022)</h2>
        </a>
        <p class="product-price"><span class="old-price">75.000đ</span> 51.000đ</p>
        <!-- Form -->
