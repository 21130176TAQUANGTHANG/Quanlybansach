...
<section class="single_product_details_area d-flex align-items-center">
    ...
    <div class="single_product_desc clearfix">
        <span>mango</span>
        <a href="cart.html">
            <h2>Bộ Sách Kể Chuyện Cuộc Đời Các Thiên Tài (Bộ 12 Cuốn)</h2>
        </a>
        <p class="product-price"><span class="old-price">729.000đ</span> 400.950đ</p>
        <!-- Form -->
