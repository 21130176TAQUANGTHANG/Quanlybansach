    ...
    <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
        ...
        <div class="header-meta d-flex clearfix justify-content-end">
            ...
            <div class="user-login-info">
                <a href="#"><img src="core-img/user.svg" alt=""></a>
            </div>
            <!-- Cart Area -->
            <div class="cart-area">
                <a href="#" id="essenceCartBtn"><img src="core-img/bag.svg" alt=""> <span>3</span></a>
            </div>
        </div>
...
<section class="single_product_details_area d-flex align-items-center">
    ...
    <div class="single_product_thumb clearfix">
        <div class="product_thumbnail_slides owl-carousel">
            ...
            <img src="https://cdn0.fahasa.com/media/flashmagazine/images/page_images/nghe_thuat_ke_chuyen_bang_hinh_anh/2024_05_03_16_04_36_2-390x510.jpg" alt="">
        </div>
    </div>
    ...
    <div class="single_product_desc clearfix">
        ...
        <p class="product-price"><span class="old-price">199.000đ</span> 143.200đ</p>
        <!-- Form -->
