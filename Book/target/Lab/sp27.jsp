...
<section class="single_product_details_area d-flex align-items-center">
    ...
    <div class="single_product_desc clearfix">
        <span>mango</span>
        <a href="cart.html">
            <h2>Mùa Hè Không Tên - Tặng Kèm Bookmark 2 Mặt + Poster Tranh + Chữ Ký Tác Giả Ngẫu Nhiên</h2>
        </a>
        <p class="product-price"><span class="old-price">130.000đ</span>91.000đ</p>
        <!-- Form -->
