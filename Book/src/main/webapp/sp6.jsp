...
<section class="single_product_details_area d-flex align-items-center">
    ...
    <div class="single_product_desc clearfix">
        <span>mango</span>
        <a href="cart.html">
            <h2>“Chém" Tiếng Anh Không Cần Động Não - Tặng Kèm Bộ Video Luyện Nghe-Nói + Sổ Học Từ Vựng</h2>
        </a>
        <p class="product-price"><span class="old-price">169.000đ</span> 126.750đ</p>
        <!-- Form -->
